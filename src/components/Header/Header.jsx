                    ...
                    <PopoverContent border='none' outline='none' h='400px' overflow='auto'>
                      ...
                      <PopoverHeader>
                        <Box>
                          ...
                          <Box fontSize={14}>
                            {/* {options.map((link, index) => <Button key={index} onClick={() => handleClick(index)} bg='none' style={index === position ? { backgroundColor: '#CCF2F0', color: '#009F94' } : {}} borderRadius='50px' _hover={{ bg: '#CCF2F0', color: '#009F94' }} fontSize={14} fontWeight='medium' mr='4'>{link}</Button>)} */}
                          </Box>
                        </Box>
                      </PopoverHeader>
                      <PopoverBody>
...
// export const NotificationList = ({}) => {
  ...
  //               <Box key={item.id} width="100%" cursor='pointer'>
  //                 <HStack
  //                   justifyContent="space-between"
  //                   alignItems="flex-start"
  //                   spacing={3}
